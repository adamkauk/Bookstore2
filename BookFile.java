...
/**
 * class BookFile This class is responsible for reading the file where all the
 * books are stored. Furthermore, this class can also write a book entry to the
 * file.
 * 
...
public class BookFile {
	 ...
	 * readBookFile - reads all the book entries from the bookstore
	 * 
	 * @return DynamicQueue with all the contents of the bookFile (i.e. all the
	...
	/**
	 * outputAllBooksToTerminal - outputs all the books in the bookstore to the
	 * terminal without sorting
	 * 
	 */
	public void outputAllBooksToTerminal() {
		Book[] books = null;
